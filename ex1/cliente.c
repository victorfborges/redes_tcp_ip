...
int main (int argc, char *argv[])
{
	...
	//while(fgets(input_text, 100, fp) != NULL){
	//	printf("%s\n", input_text); 
	//}
	...
	/* verificação da passagem do numero do cliente como parametros */
	if(argc==3){
		*final_text=argv[2];
	}		
	else{
		printf("client number not available\n");
		exit(1);
	}
	
	/* montagem da mensagem lida do arquivo */
	strcat(final_text, input_text);
